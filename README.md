...
| 發生原因 / 解決方案 | IP Ratelimit | [Queue based load leveling](https://docs.microsoft.com/zh-tw/azure/architecture/patterns/queue-based-load-leveling) | istio 熔斷 | 縮短 timeout | 探針 | Auto-scale |
|---|---|---|---|---|---|---|
| endpoint timeout (表太大，第三方API問題 等) | - | O | 客戶失敗, 影響其他 endpoint | O | - | -|  
| 服務無法訪問 | - | - | - | - | O | - | 
| CPU/MEM 耗盡 | 客戶失敗 | O | O| - | - | O | 
